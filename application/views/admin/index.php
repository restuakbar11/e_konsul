      ...
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/konsultasi') ?>"><div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Konsultasi yang belum direspon</div></a>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/konsultasi_tolak') ?>"><div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Konsultasi yang ditolak</div></a>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/konsultasi_terima') ?>"><div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Konsultasi yang sudah diterima</div></a>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/konsultasi_semua') ?>"><div class="text-xs font-weight-bold text-success text-uppercase mb-1">Semua konsultasi</div></a>
            </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/bertemu_tolak') ?>">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/bertemu_terima') ?>">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <a href="<?= base_url('admin/bertemu_semua') ?>"><div class="text-xs font-weight-bold text-success text-uppercase mb-1">Semua pertemuan</div></a>
            </div>
